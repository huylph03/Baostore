    ...
    <!-- Cart Start -->
    <div class="container-fluid pt-5 border-top mt-5">
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
            <h3 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Giỏ hàng của bạn</span></h3>
